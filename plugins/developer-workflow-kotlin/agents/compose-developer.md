...
| **Migration brief** | Old impl files + pattern constraints + shared components list (or explicit migration skill handoff) | Follow the brief exactly. **Skip Step 1.** |
